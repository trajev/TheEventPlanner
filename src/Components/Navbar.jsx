    ...
    return (
        <>
            ...
            <nav className='h-[41px] w-screen bg-[#FFFBFB] py-6 px-5 flex items-center border gap-5 '>
                ...
                <a href="#" className='text-lg leading-4 p-2 '>Services</a>
                <a href="#" className='text-lg leading-4 p-2 '>Testimonials</a>
                <a href="#" className='text-lg leading-4 p-2 '>Contact Us</a>
            </nav>
        </>
    )
}
