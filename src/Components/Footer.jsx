  ...
  return (
    <div className="w-full mt-10 h-70 bg-[#333333] sm:px-14 px-2 py-6 text-white flex flex-col sm:flex-row sm:items-start sm:justify-between">
      <div className="w-full sm:w-[33%] h-full p-4 overflow-hidden">
        ...
        <img src="https://images.vexels.com/media/users/3/145234/isolated/preview/931cd261ad78d0c4f0b2ceda893e142b-event-planning-logotype-by-vexels.png" alt="logo" className=" scale-150 mb-4 mx-10 w-28" />
