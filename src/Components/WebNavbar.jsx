            ...
            <Navbar expand="lg" className="bg-body primary p-0 bg-[#FFFBFB] mx-10">
                <Container fluid>
                    <Navbar.Brand onClick={() => navigate("/")}>
                        ...
                        <Nav.Link onClick={() => { navigate("/") }} > <img src="Event-Planner-assets/mainlogo-bgremoved_11zon.jpg" alt="logo" className="h-16 object-cover scale-100 sm:scale-150 cursor-pointer w-28 " /> </Nav.Link>
                    </Navbar.Brand>
